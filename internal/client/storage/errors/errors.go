...
var (
	...
	ErrLoginPasswordTblIndex = "Выберите в таблице логин-пароль, который хотите удалить"
	ErrTextTblIndex          = "Выберите в таблице текст, который хотите удалить"
	ErrCardTblIndex          = "Выберите в таблице карту, которую хотите удалить"
)
